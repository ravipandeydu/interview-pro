...
export const RecruiterInterview = ({
  interviewId,
}: RecruiterInterviewProps) => {
              ...
              <CardContent>
                ...
                <TabsContent value="questions" className="space-y-4">
                  {interview.questions.map((question, index) => (
                    <Card key={question.id} className="border border-border/40 bg-background/60 backdrop-blur-xl backdrop-filter shadow-lg relative overflow-hidden">
                ...
                <TabsContent value="submissions" className="space-y-4">
                  {submissions && submissions.length > 0 ? (
                    submissions.map((submission, i) => {
                      ...
                      return (
                        <Card key={submission.id} className="border border-border/40 bg-background/60 backdrop-blur-xl backdrop-filter shadow-lg relative overflow-hidden">
                          <div className="absolute inset-0 bg-gradient-to-br from-indigo-500/5 via-transparent to-purple-500/5 z-0" />
                          <CardHeader className="relative z-10">
                            <div className="flex justify-between">
                              <CardTitle className="bg-clip-text text-transparent bg-gradient-to-r from-indigo-600 to-purple-600 dark:from-indigo-400 dark:to-purple-400">
                              ...
                              <Badge variant="outline" className="bg-background/60 backdrop-blur-sm border border-indigo-500/30">
                                {new Date(
